...
export type DualityPairMsg = {
  sync_orderbook: {};
} | {
  update_orderbook_config: UpdateDualityOrderbook;
};
...
export interface UpdateDualityOrderbook {
  avg_price_adjustment?: Decimal | null;
  enable?: boolean | null;
  executor?: string | null;
  liquidity_percent?: Decimal | null;
  min_asset_0_order_size?: Uint128 | null;
  min_asset_1_order_size?: Uint128 | null;
  orders_number?: number | null;
  remove_executor?: boolean;
}
