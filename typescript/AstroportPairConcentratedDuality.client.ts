...
export interface AstroportPairConcentratedDualityReadOnlyInterface {
...
export class AstroportPairConcentratedDualityQueryClient implements AstroportPairConcentratedDualityReadOnlyInterface {
...
export interface AstroportPairConcentratedDualityInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
  ...
  custom: (dualityPairMsg: DualityPairMsg, fee_?: number | StdFee | "auto", memo_?: string, funds_?: Coin[]) => Promise<any>;
}
export class AstroportPairConcentratedDualityClient implements AstroportPairConcentratedDualityInterface {
  ...
  custom = async (dualityPairMsg: DualityPairMsg, fee_: number | StdFee | "auto" = "auto", memo_?: string, funds_?: Coin[]): Promise<any> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      custom: dualityPairMsg
    }, fee_, memo_, funds_);
  };
}