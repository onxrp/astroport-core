...
export interface AstroportPairXykSaleTaxReadOnlyInterface {
...
export class AstroportPairXykSaleTaxQueryClient implements AstroportPairXykSaleTaxReadOnlyInterface {
...
export interface AstroportPairXykSaleTaxInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class AstroportPairXykSaleTaxClient implements AstroportPairXykSaleTaxInterface {
