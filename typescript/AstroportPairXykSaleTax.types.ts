...
export interface MigrateMsg {
  tax_config_admin: string;
  tax_configs: TaxConfigsForString;
}
export interface TaxConfigsForString {
  [k: string]: TaxConfigForString;
}
export interface TaxConfigForString {
  tax_rate: Decimal;
  tax_recipient: string;
}
