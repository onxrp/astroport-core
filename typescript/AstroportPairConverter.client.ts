...
export interface AstroportPairConverterReadOnlyInterface {
...
export class AstroportPairConverterQueryClient implements AstroportPairConverterReadOnlyInterface {
...
export interface AstroportPairConverterInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class AstroportPairConverterClient implements AstroportPairConverterInterface {
