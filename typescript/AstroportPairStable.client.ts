...
export class AstroportPairStableQueryClient implements AstroportPairStableReadOnlyInterface {
...
export interface AstroportPairStableInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class AstroportPairStableClient implements AstroportPairStableInterface {
