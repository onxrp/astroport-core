...
export interface AstroportPairConcentratedSaleTaxReadOnlyInterface {
...
export class AstroportPairConcentratedSaleTaxQueryClient implements AstroportPairConcentratedSaleTaxReadOnlyInterface {
...
export interface AstroportPairConcentratedSaleTaxInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class AstroportPairConcentratedSaleTaxClient implements AstroportPairConcentratedSaleTaxInterface {
